...
interface Props { bus: BusPosition; onClose: () => void; onReport: () => void; darkMap: boolean }

export default function BusInfoSheet({ bus, onClose, onReport, darkMap }: Props) {
  const statusMap = {
      ...
      <div style={{padding:'16px 20px 24px'}}>
        ...
        <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',marginBottom:'20px'}}>
          <div style={{display:'flex',alignItems:'center',gap:'14px'}}>
            <div style={{width:'52px',height:'52px',borderRadius:'14px',background:darkMap ? 'linear-gradient(145deg,#1E2638,#131921)' : 'linear-gradient(145deg,#F1F5F9,#E2E8F0)',border:darkMap ? '1px solid rgba(184,200,224,0.15)' : '1px solid rgba(0,0,0,0.08)',display:'flex',alignItems:'center',justifyContent:'center',boxShadow:darkMap ? '0 4px 16px rgba(0,0,0,0.6), inset 0 1px 0 rgba(184,200,224,0.08)' : '0 4px 16px rgba(0,0,0,0.03), inset 0 1px 0 rgba(255,255,255,0.8)'}}>
          ...
          <button onClick={onClose} style={{width:'34px',height:'34px',borderRadius:'50%',background:darkMap ? 'rgba(184,200,224,0.06)' : 'rgba(0,0,0,0.03)',border:darkMap ? '1px solid rgba(184,200,224,0.1)' : '1px solid rgba(0,0,0,0.08)',display:'flex',alignItems:'center',justifyContent:'center',cursor:'pointer'}}>
        ...
        <div className="platinum-card" style={{borderRadius:'var(--r-md)',padding:'14px 16px',marginBottom:'14px'}}>
          ...
          <div style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
            ...
            <div style={{display:'flex',alignItems:'center',gap:'5px',background:darkMap ? 'rgba(184,200,224,0.06)' : 'rgba(0,0,0,0.03)',border:darkMap ? '1px solid rgba(184,200,224,0.12)' : '1px solid rgba(0,0,0,0.08)',borderRadius:'10px',padding:'6px 12px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:'8px',marginBottom:'14px'}}>
          {[
            ...
            <div key={label} style={{background:darkMap ? 'rgba(6,8,16,0.6)' : 'rgba(255,255,255,0.85)',border:darkMap ? '1px solid rgba(184,200,224,0.07)' : '1px solid rgba(0,0,0,0.08)',borderRadius:'var(--r-md)',padding:'12px',textAlign:'center'}}>
